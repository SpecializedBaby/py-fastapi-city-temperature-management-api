...
@temperature_router.put("/temperatures/update/")
...
@temperature_router.get("/temperatures/", response_model=TemperatureBase)
...
@temperature_router.get("/temperatures/", response_model=TemperatureRead)
